...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print(f"% Match : {results_stats_dic['pct_match']}")
    
    if print_incorrect_dogs:
        print("Misclassified Dogs :")
        for img_path in results_dic:
            if sum(results_dic[img_path][3:]) == 1:
                print(f"Pet label : {results_dic[img_path][0]}, Classifier label : {results_dic[img_path][1]}.")
    
    if print_incorrect_breed:
        print("Misclassified Breeds :")
        for img_path in results_dic:
            if (sum(results_dic[img_path][3:]) == 2) and (results_dic[img_path][2] == 0):
                print(f"Pet label : {results_dic[img_path][0]}, Classifier label : {results_dic[img_path][1]}.")